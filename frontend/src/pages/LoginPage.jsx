    ...
    <div className="auth-page">
      ...
      <div className="auth-container">
        ...
        <div className="auth-card glass-card glass-card-glow">
          ...
          <p className="auth-subtitle">Sign in to continue filing your FIR.</p>

          {/* Tab switcher — links to sibling page */}
          <div className="auth-tabs">
            <button className="auth-tab active" disabled>Sign In</button>
        ...
        <div className="auth-steps-indicator">
          <div className="auth-step-dot active" title="Sign In" />
